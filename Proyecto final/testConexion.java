...
public class testConexion {
	...
	public static void main(String[] args) {
		...
		try {
			...
			rs = stm.executeQuery("SELECT * FROM bd_prueva.usuarios;");//aqui dictamos la sentencia SQL
			...
			while (rs.next()/**/) {
				...
				System.out.println(idUsuario+" | "+Usuario+" | "+Clave+" | "+Nombre+" | "+Apellido+" | "+Telefono+" | "+Correo);
			}
